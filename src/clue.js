...
function pickMystery() {
  ...
  let nameSuspect = selectRandom(suspectsArray)
  let nameRoom =selectRandom(roomsArray)
  let nameWeapon =selectRandom(weaponsArray)

  if(nameSuspect && nameRoom && nameWeapon) {
    return {suspect: nameSuspect, weapon: nameWeapon, room: nameRoom}
  } else {
    return 'Hay un error'
  }
